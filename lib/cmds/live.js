...
exports.run = (client, msg) => new Promise(async (resolve, reject) => {
  ...
  const liveSubs = client.utils.get(['body'], await request.get('https://info.dbkynd.com/getLiveSubs'));
  ...
  msg.channel.send(`**${strings.length}** of Anne's subscribers are currently live. :pogchamp:\n` +
