    ...
    .then(async m => {
      try {
        ...
        const results = await Promise.all([
          ...
          fetch2(`https://public-ubiservices.ubi.com/v1/spaces/${spaces[platform]}/sandboxes/OSBOR_PC_LNCH_A/r6karma/players?board_id=pvp_ranked&profile_ids=${userId}&region_id=ncsa&season_id=-1`),
          fetch2(`https://public-ubiservices.ubi.com/v1/spaces/${spaces[platform]}/sandboxes/OSBOR_PC_LNCH_A/r6karma/players?board_id=pvp_ranked&profile_ids=${userId}&region_id=emea&season_id=-1`),
