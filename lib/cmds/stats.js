...
exports.run = (client, msg) => new Promise((resolve, reject) => {
  ...
  pusage.stat(process.pid, (err, stat) => {
    ...
    if (err) {
      ...
      str += '\n--Twitter Stats--\n';
      str += `Users: ${client.utils.get(['twitter', 'ids', 'length'], client)}\n`;
      str += `Channels: ${client.utils.get(['twitter', 'channels'], client)}\n`;

      str += '\n--Twitch Stats--\n';
      str += `Users: ${client.utils.get(['twitch', 'users'], client)}\n`;
      str += `Channels: ${client.utils.get(['twitch', 'channels'], client)}\n`;
