...
exports.run = (client, msg) => new Promise((resolve, reject) => {
  ...
  pusage.stat(process.pid, (err, stat) => {
    ...
    if (err) {
      ...
      str += '\n--Twitter Stats--\n';
      str += `Users: ${client.utils.get(['twitter', 'ids', 'length'], client) || 0}\n`;
      str += `Channels: ${client.utils.get(['twitter', 'channels'], client) || 0}\n`;

      str += '\n--Twitch Stats--\n';
      str += `Users: ${client.utils.get(['twitch', 'users'], client) || 0}\n`;
      str += `Channels: ${client.utils.get(['twitch', 'channels'], client) || 0}\n`;
