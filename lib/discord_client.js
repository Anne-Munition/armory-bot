...
module.exports = function (options, mongo) {
    ...
    function discordConnect() {
        ...
        discord.login(options.bot_token, (err) => { //Using a Discord 'BOT' account token
    ...
    discord.on('serverNewMember', (server, user) => { //A new member has joined a connected server
        mongo.welcomeChannels.find({server_id: server.id}, (err, channels) => { //Get list of welcome channels with same server_id
