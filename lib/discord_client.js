...
module.exports = function (utils, options, path, mongo) {
	...
	discord.on('serverMemberRemoved', (server, user) => {
		if (server.id != '84764735832068096') return;
		discord.sendMessage('85090217551204352', "**" + user.username + "** was removed from the Discord Server");
	});
