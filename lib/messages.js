    ...
    function ow(message, query) {
        ...
        function scrapeData(html, url, region) {
            ...
            if (prestige_image == "background-image:url(https://d1u1mce87gyfbn.cloudfront.net/game/playerlevelrewards/0x0250000000000922_Rank.png)") {
                ...
                level += 200;
            } else if (prestige_image == "background-image:url(https://d1u1mce87gyfbn.cloudfront.net/game/playerlevelrewards/0x0250000000000940_Rank.png)") {
                level += 300;
            }
        ...
        function showResults(stats, url) {
            if (stats.game_hours == "") return discord.typeMessage(message, "``" + name + "`` has an Overwatch profile, but has no time played.");
