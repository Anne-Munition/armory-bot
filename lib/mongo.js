...
module.exports = (client) => {
  ...
  const welcomeChannels = mongoose.model(
    'welcome_channels',
    {
      server_id: String,
      channel_id: String,
  ...
  const auditChannels = mongoose.model(
    'audit_channels',
    {
      server_id: String,
      channel_id: String,
  ...
  const guildConfigs = mongoose.model(
    'guild_configs',
    {
      server_id: String,
      config: Object,
  ...
  const twitchChannels = mongoose.model(
    'twitch_channels',
    {
      channels: Array,
      display_name: String,
  ...
  const timeouts = mongoose.model('timeouts', {
    discordId: String,
    expiresAt: Date,
    username: String,
  })
