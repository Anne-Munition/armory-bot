...
async function removeTimeout(id) {
  ...
  const target = client.guilds.get('84764735832068096').members.get(id);
  if (target) {
  ...
  client.guilds.get('84764735832068096')
      .channels.get('707788445774512128')
      .send(`The timeout has ended for **${targetString}**`).catch();
