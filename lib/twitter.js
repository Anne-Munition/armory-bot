...
module.exports = function (utils, options, discord, mongo) {
    ...
    function handleTweet(tweet) {
        ...
        mongo.twitterChannelsModel.find({}, (err, channels) => { //Get the channel ids to post tweets to
    ...
    function deleteTweet(tweet) {
        mongo.tweetMessagesModel.findOne({tweet_id: tweet.delete.status.id_str}, (err, result) => { //Get the list of messages
            if (!result) return;
