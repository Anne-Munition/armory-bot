...
const puns = [
  ...
  'All these sea monster jokes are Kraken me up.',
  ...
  'I got fired as train engineer. They tallied up all my accidents, it was so hard to keep track.',
  ...
  'What’s the worst part about movie theater candy prices? They’re always raisinet.',
  'Why is peter pan always flying? He neverlands.',
  'What did the librarian say when the books were a mess? We ought to be ashamed of ourshelves.',
  'Why did the police go to a daycare center? A 3-year-old was resisting a rest.',
  'Why did the tomato blush? Because it saw the salad dressing.',
  'Did you hear the rumor about peanut butter? I’m not telling you. You might spread it.',
  'What do you call cheese that isn’t yours? Nacho cheese.',
  'Why couldn’t the sesame seed leave the poker table? A: He was on a roll.',
  'I sent ten puns into a contest hoping one would win. No pun in ten did.',
  'How much room should you give fungi to grow? As mushroom as possible.',
  'I cut my finger shredding cheese, but I think I may have grater problems.',
  'How do trees get online? They just log in.',
  'Why are dogs bad storytellers? Because they only have one tale.',
  'Why shouldn’t you tell a secret on a farm? Because the potatoes have eyes and the corn has ears.',
  'Why do hamburgers go to the gym? To get better buns.',
  'What do you do when life gives you melons? See a doctor, you’re probably dyslexic.',
  ...
  'Mummifying puns are so disheartening.',
  'Why does a chicken coop have two doors? If it had four, it would be a chicken sedan.',
  'Why shouldn’t you mention the number 288? It’s two gross.',
  'Why did the mathematician’s numeral keep ending up in the wrong place? It was Roman.',
  ...
  'Which is faster, heat or cold? Heat, you can catch cold.',
  ...
  'Advanced math is easy as pi.',
  'Why does coffee hate mornings? It keeps getting mugged.',
  ...
  'Learning to sleep upside down is hard for bats, but they get the hang of it.',
  'Waking up is an eye-opening experience.',
  'I used to be a banker, until I lost interest.',
  'Why couldn’t the coffee go out? It was grounded.',
  'No matter how hard you push the envelope, it will still be stationery.',
  'When I get undressed in the bathroom, the shower usually gets turned on.',
